...
namespace Shared.Extensions
{
    public static class ObjectExtensions
    {
        ...
        public static async Task<string> JsonSerializeAsync(this object value)
            => await new Func<object, string>(JsonConvert.SerializeObject).RunAsync(value);

        public static async Task<string> JsonSerializeAsync(this object value, Formatting formatting)
            => await new Func<object, Formatting, string>(JsonConvert.SerializeObject).RunAsync(value, formatting);

        public static async Task<string> JsonSerializeAsync(this object value, params JsonConverter[] converters)
        ...
        public static async Task<string> JsonSerializeAsync(this object value, JsonSerializerSettings settings)
            => await new Func<object, JsonSerializerSettings, string>(JsonConvert.SerializeObject)
                .RunAsync(value, settings);

        public static async Task<string> JsonSerializeAsync(this object value, Type type,
        ...
        public static async Task<string> JsonSerializeAsync(this object value, Type type, Formatting formatting,
            JsonSerializerSettings settings)
        ...
        public static string JsonSerialize(this object value, JsonSerializerSettings settings)
            => JsonConvert.SerializeObject(value, settings);

        public static string JsonSerialize(this object value, Type type,
            JsonSerializerSettings settings)
        ...
        public static string JsonSerialize(this object value, Type type, Formatting formatting,
            JsonSerializerSettings settings)
